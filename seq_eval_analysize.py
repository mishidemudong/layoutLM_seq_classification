...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 24 16:48:50 2020
...
def dest_report(y_true, y_pred, dest_type, digits=2, suffix=False):
    """Build a text report showing the main classification metrics.
    ...
    for type_name, true_entities in d1.items():
        ...
        if type_name == dest_type:
            dest_result['precision'],dest_result['recall'],dest_result['f1'] = p, r, f1
